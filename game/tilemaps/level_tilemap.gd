...
#	emit_signal("tilemap_completed", floor_cells_global_positions, player_spawn_cell_global_position) # pošljem v GM
	emit_signal("tilemap_completed", floor_cells_global_positions, player_start_global_position)
	printt("tutorial_tilemap_complete", floor_cells_global_positions.size(), player_start_global_position)
