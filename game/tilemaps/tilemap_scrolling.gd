...
#		# namen: dodajanje med tla, da stray lahko gre čez
#	# namen: vse, ki so tla pred menjavo tiletov, so scroller spawn pozicije
#
#	var scrolling_stray_spawn_positions: Array
#
...
#			$SolutionLine.hide()
#
#	# prečesi vse celice in določi globalne pozicijedd
...
##					scrolling_stray_spawn_positions.append(cell_global_position)
