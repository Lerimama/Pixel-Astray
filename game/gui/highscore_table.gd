...
func get_highscore_table(current_level, current_player_ranking):
	...
	# var current_level_highscores = Global.data_manager.read_highscores_from_file(Global.game_manager.game_data["level"])
#	var current_level_highscores = Global.data_manager.read_highscores_from_file(Profiles.level_data["level"])
