...
# hs
onready var name_input_popup: Control = $GameSummary/NameInputPopup
onready var name_input: LineEdit = $GameSummary/NameInputPopup/NameInput
...
func fade_in_duel():
	...
	focus_btn = $GameSummary/ContentDuel/Menu/RestartBtn
...
func fade_in_no_highscore(gameover_reason): # title in potem game summary
	...
	if Global.game_manager.game_data["game"] == Profiles.Games.DUEL:
		...
		focus_btn = $GameSummary/ContentTutorial/Menu/QuitBtn
		choose_gameover_title(gameover_reason)
	else:
		current_content = content_game
		focus_btn = $GameSummary/ContentGame/Menu/RestartBtn
		choose_gameover_title(gameover_reason)
...
func fade_in_highscore(gameover_reason): # samo title in name input
	...
	var restart_btn = $GameSummary/ContentGame/Menu/RestartBtn # za focus
...
#		$ContentTutorial/DataContainer/Points.text %= str(Global.game_manager.p1_stats["player_points"])
#		$ContentTutorial/DataContainer/CellsTraveled.text %= str(Global.game_manager.p1_stats["cells_traveled"])
#		$ContentTutorial/DataContainer/BurstCount.text %= str(Global.game_manager.p1_stats["burst_count"])
#		$ContentTutorial/DataContainer/SkillsUsed.text %= str(Global.game_manager.p1_stats["skill_count"])
#		$ContentTutorial/DataContainer/PixelsOff.text %= str(Global.game_manager.p1_stats["colors_collected"])
...
#		$ContentGame/DataContainer/Points.text %= str(Global.game_manager.p1_stats["player_points"])
#		$ContentGame/DataContainer/Time.text %= str(time_used)
#		$ContentGame/DataContainer/CellsTraveled.text %= str(Global.game_manager.p1_stats["cells_traveled"])
#		$ContentGame/DataContainer/BurstCount.text %= str(Global.game_manager.p1_stats["burst_count"])
#		$ContentGame/DataContainer/SkillsUsed.text %= str(Global.game_manager.p1_stats["skill_count"])
#		$ContentGame/DataContainer/PixelsOff.text %= str(Global.game_manager.p1_stats["colors_collected"])
...
func _on_ConfirmBtn_pressed() -> void:
	$GameSummary/NameInputPopup/HBoxContainer/ConfirmBtn.grab_focus() # da se obarva ko stisnem RETURN
...
func _on_CancelBtn_pressed() -> void:
	$GameSummary/NameInputPopup/HBoxContainer/CancelBtn.grab_focus() # da se obarva ko stisnem ESC
