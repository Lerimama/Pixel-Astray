...
#		if proces_respawn_positions.empty():
			return
...
#		var random_range = proces_respawn_positions.size()
...
#		var selected_position = proces_respawn_positions[selected_position_index]
