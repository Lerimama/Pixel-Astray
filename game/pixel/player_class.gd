...
#	pixel_color = Global.game_manager.game_settings["player_start_color"]
	...
	# life .. če ga ne izgubiš na hit, je lajf samo 1
	if not Global.game_manager.game_settings["lose_life_on_hit"]:
		change_stat("set_life_trivial", 1)
...
func pull(stray_to_move: KinematicBody2D): # skilled inputs opredeli vrsto skila glede na kolajderja
	...
	var stray_to_move_prepull_position: Vector2 = stray_to_move.global_position
