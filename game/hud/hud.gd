...
#
#	if Global.game_manager.game_data.has("level_goal_count"): # NEST reverese spectrum
#		stray_in_indicator_alpha = stray_out_indicator_alpha
#		stray_out_indicator_alpha = 1
